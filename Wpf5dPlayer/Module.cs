    ...
    public class Module
    {
        ...
        public static void readFile()
        {
            try
            {
                ...
                actionFile = File.ReadAllBytes(Player.fullPathName.Substring(0, Player.fullPathName.LastIndexOf(".")) + "-D");
            }
            catch
            {
                actionFile = null;
            ...
            try
            {
                ...
                effectFile = File.ReadAllBytes(Player.fullPathName.Substring(0, Player.fullPathName.LastIndexOf(".")) + "-T");
            }
            catch
            {
            ...
            try
            {
                shakeFile = File.ReadAllBytes(Player.fullPathName.Substring(0, Player.fullPathName.LastIndexOf(".")) + "-S");
            }
            catch
            {                
                shakeFile = null;
